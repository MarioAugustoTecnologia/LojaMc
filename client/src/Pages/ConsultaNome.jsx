...
const ConsultaNome = ({item}) => {
  ...
  var table = pedido.filter(item => item.nome.toLowerCase().includes(buscarap))
   ...
   <div className="">
      ...
      <div className="d-flex justify-content-between bg-secondary py-3 px-5 text-white" >       
        ...
        <div className="d-flex">
             ...
             <input type="search" style={{ width: "200px", height: '25px', margin: '0 15px' }} placeholder="Digite o nome do Cliente:" className="form-control rounded-0" value={buscapedido} onChange={(e) => setBuscaPedido(e.target.value)} />
        </div>
