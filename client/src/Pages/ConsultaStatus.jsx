      ...
      <div className="d-flex justify-content-between bg-secondary py-3 px-5 text-white" style={{ width: "160%" }}>
        ...
        <div className="d-flex">
            <a href="" className="navbar-brand text-white fs-5">Pesquisar:</a>
             <input placeholder="Digite o status do pedido:" type="search" style={{ margin: "0 15px", width: "300px" }} className="form-control rounded-0" value={buscapedido} onChange={(e) => setBuscaPedido(e.target.value)} />
        </div>
