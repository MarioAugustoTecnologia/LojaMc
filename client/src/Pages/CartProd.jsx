        ...
        <div className="row ">
          <div className="col-8">
            ...
            <div className='border-none mb-3'>
              ...
              <div className='detail ms-4'>
                <input type="text" id="desc" readOnly style={{ border: 'none', width: '450px', fontSize: '17px' }} value={descricao} onChange={e => descchange(e.target.value)} /> <br />
          ...
          <div className="col-4" style={{marginTop:'-30px'}} >
            <div className="p-3">
              ...
              <h7 style={{ color: 'navy', backgroundColor: 'white', fontWeight: 'bold', fontSize: '17px' }}>Total Geral: <a style={{ color: 'green', backgroundColor: 'white', fontWeight: 'bold', fontSize: '17px' }} id="total">R${totalgeral}</a> </h7><br />
